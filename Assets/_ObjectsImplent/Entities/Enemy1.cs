...
public class Enemy1 : Character1
{
    ...
    [SerializeField] protected Bullet1 bulletPrefab;
    

    protected Weapon1 enemyWeapon;
    protected Weapon1 explodingWeapon;
    ...
    protected override void Start()
    {
        ...
        enemyWeapon = new Weapon1(bulletPrefab); // Activity Diagram : set weapon
    }
        ...
        public void ChangedHealth(int health)
    {
        ...
        {
            //increase score
            GameManager1.singleton.scoreManager.IncreaseScore();
    ...
    public Enemy1(string enemyName1)
    {
